 ...
 <?php
                ...
                if(empty($folder_name)) {
                  ...
                  //   $search = 0;
                    ...
                    $total = $conn->query("SELECT * FROM files WHERE folder_name = '$folder_name' ORDER BY id DESC LIMIT 1000");
                    ...
                    $sql = "SELECT * FROM files WHERE folder_name = '$folder_name' ORDER BY id DESC LIMIT $start_index, $results_per_page ";
